...
bool isaacsim_msgs__msg__quat__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("isaacsim_msgs.msg._quat.Quat", full_classname_dest, 28) == 0);
  }
  isaacsim_msgs__msg__Quat * ros_message = _ros_message;
  {  // w
...
PyObject * isaacsim_msgs__msg__quat__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("isaacsim_msgs.msg._quat");
