...
#ifndef ISAACSIM_MSGS__SRV__DETAIL__URDF_TO_USD__FUNCTIONS_H_
#define ISAACSIM_MSGS__SRV__DETAIL__URDF_TO_USD__FUNCTIONS_H_
...
/// Initialize srv/UrdfToUsd message.
/**
...
/// Finalize srv/UrdfToUsd message.
/**
...
/// Create srv/UrdfToUsd message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * isaacsim_msgs__srv__UrdfToUsd_Request__init().
...
/// Destroy srv/UrdfToUsd message.
/**
 * It calls
 * isaacsim_msgs__srv__UrdfToUsd_Request__fini()
...
/// Check for srv/UrdfToUsd message equality.
/**
...
/// Initialize array of srv/UrdfToUsd messages.
/**
...
/// Finalize array of srv/UrdfToUsd messages.
/**
 * It calls
 * isaacsim_msgs__srv__UrdfToUsd_Request__fini()
...
/// Create array of srv/UrdfToUsd messages.
/**
 * It allocates the memory for the array and calls
 * isaacsim_msgs__srv__UrdfToUsd_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/UrdfToUsd messages.
/**
 * It calls
 * isaacsim_msgs__srv__UrdfToUsd_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/UrdfToUsd message array equality.
/**
...
/// Copy an array of srv/UrdfToUsd messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * isaacsim_msgs__srv__UrdfToUsd_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_isaacsim_msgs
...
/**
 * It calls
 * isaacsim_msgs__srv__UrdfToUsd_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_isaacsim_msgs
...
/**
 * It allocates the memory for the array and calls
 * isaacsim_msgs__srv__UrdfToUsd_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_isaacsim_msgs
...
/**
 * It calls
 * isaacsim_msgs__srv__UrdfToUsd_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ISAACSIM_MSGS__SRV__DETAIL__URDF_TO_USD__FUNCTIONS_H_
