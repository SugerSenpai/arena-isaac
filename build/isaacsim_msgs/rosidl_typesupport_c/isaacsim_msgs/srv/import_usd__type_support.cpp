...
static const _ImportUsd_Request_type_support_symbol_names_t _ImportUsd_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, isaacsim_msgs, srv, ImportUsd_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, isaacsim_msgs, srv, ImportUsd_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, isaacsim_msgs, srv, ImportUsd_Request)() {
  return &::isaacsim_msgs::srv::rosidl_typesupport_c::ImportUsd_Request_message_type_support_handle;
}
...
static const _ImportUsd_Response_type_support_symbol_names_t _ImportUsd_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, isaacsim_msgs, srv, ImportUsd_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, isaacsim_msgs, srv, ImportUsd_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, isaacsim_msgs, srv, ImportUsd_Response)() {
  return &::isaacsim_msgs::srv::rosidl_typesupport_c::ImportUsd_Response_message_type_support_handle;
}
...
static const _ImportUsd_type_support_symbol_names_t _ImportUsd_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, isaacsim_msgs, srv, ImportUsd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, isaacsim_msgs, srv, ImportUsd)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, isaacsim_msgs, srv, ImportUsd)() {
  return &::isaacsim_msgs::srv::rosidl_typesupport_c::ImportUsd_service_type_support_handle;
}
