...
static const _ImportUrdf_Request_type_support_symbol_names_t _ImportUrdf_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, isaacsim_msgs, srv, ImportUrdf_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, isaacsim_msgs, srv, ImportUrdf_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, isaacsim_msgs, srv, ImportUrdf_Request)() {
  return &::isaacsim_msgs::srv::rosidl_typesupport_c::ImportUrdf_Request_message_type_support_handle;
}
...
static const _ImportUrdf_Response_type_support_symbol_names_t _ImportUrdf_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, isaacsim_msgs, srv, ImportUrdf_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, isaacsim_msgs, srv, ImportUrdf_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, isaacsim_msgs, srv, ImportUrdf_Response)() {
  return &::isaacsim_msgs::srv::rosidl_typesupport_c::ImportUrdf_Response_message_type_support_handle;
}
...
static const _ImportUrdf_type_support_symbol_names_t _ImportUrdf_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, isaacsim_msgs, srv, ImportUrdf)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, isaacsim_msgs, srv, ImportUrdf)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, isaacsim_msgs, srv, ImportUrdf)() {
  return &::isaacsim_msgs::srv::rosidl_typesupport_c::ImportUrdf_service_type_support_handle;
}
