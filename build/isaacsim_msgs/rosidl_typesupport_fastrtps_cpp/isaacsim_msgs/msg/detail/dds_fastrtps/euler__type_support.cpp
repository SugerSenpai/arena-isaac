...
#include "isaacsim_msgs/msg/detail/euler__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const isaacsim_msgs::msg::Euler & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  isaacsim_msgs::msg::Euler & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = isaacsim_msgs::msg::Euler;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const isaacsim_msgs::msg::Euler *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<isaacsim_msgs::msg::Euler *>(
    untyped_ros_message);
...
{
  return &isaacsim_msgs::msg::typesupport_fastrtps_cpp::_Euler__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, isaacsim_msgs, msg, Euler)() {
  return &isaacsim_msgs::msg::typesupport_fastrtps_cpp::_Euler__handle;
}
