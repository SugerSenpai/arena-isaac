...
#include "isaacsim_msgs/msg/detail/quat__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const isaacsim_msgs::msg::Quat & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  isaacsim_msgs::msg::Quat & ros_message)
{
  // Member: w
  cdr >> ros_message.w;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = isaacsim_msgs::msg::Quat;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const isaacsim_msgs::msg::Quat *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<isaacsim_msgs::msg::Quat *>(
    untyped_ros_message);
...
{
  return &isaacsim_msgs::msg::typesupport_fastrtps_cpp::_Quat__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, isaacsim_msgs, msg, Quat)() {
  return &isaacsim_msgs::msg::typesupport_fastrtps_cpp::_Quat__handle;
}
